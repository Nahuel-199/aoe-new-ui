...
import { HStack, VStack, useBreakpointValue, Field, IconButton, Drawer, Portal, Button, CloseButton, Flex } from "@chakra-ui/react";
...
export default function ProductFilters({
    ...
    const typeCollection = createListCollection({
        items: [{ label: "Todos", value: "all" }, ...uniqueTypes.map(t => ({ label: t, value: t }))],
    });
