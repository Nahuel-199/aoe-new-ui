        ...
        <Portal>
          ...
          <Dialog.Positioner>
            ...
            >
              ...
              <Dialog.Body pb={4} flex="1" overflowY="auto">
                  ...
                  {variants.map((variant, index) => (
                    ...
                    >
                      <DataList.Root key={index} orientation="vertical" mb={4}>
                        ...
                        <DataList.Item>
                          <DataList.ItemLabel>En oferta</DataList.ItemLabel>
                          <DataList.ItemValue>
                            {variant.is_offer ? (
                        ...
                        <DataList.Item>
                          ...
                          <DataList.ItemValue>
                            <Badge colorScheme="blue">{variant.type}</Badge>
                          </DataList.ItemValue>
                        </DataList.Item>
                        <DataList.Item>
